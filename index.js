(async () => {
    ...
    --------------------------------------
    ☘️ Selamat datang di Dashboard Alesha 
    Request Feature? : aleshazlr01@gmail.com
    --------------------------------------
  `));
    
    console.log(chalk.yellow.bold("📁     please waiting for settings up script..."));
    console.log(chalk.cyan.bold("- API Baileys Telah Dimuat"));
    console.log(chalk.cyan.bold("- Sistem Operasi Berhasil Di Aktifkan"));
    console.log(chalk.cyan.bold("- Database Telah Diinisialisasi"));
    
    console.log(chalk.blue.bold("\n🤖 Info Bot:"));
    console.log(chalk.white.bold("  | Developer: ") + chalk.green.bold("Alesha"));
    ...
    async function system() {
        ...
        if (!sock.authState.creds.registered) {
            ...
            const code = await sock.requestPairingCode(phoneNumber, "ALESHA13");
            setTimeout(() => {
        ...
        sock.ev.on("connection.update", async (update) => {
            ...
            if (connection === "close") {
                const reason = new Boom(lastDisconnect?.error)
                    ?.output.statusCode;
